    ...
    <html lang="en" className="bg-primary relative z-10">
      <head>
        ...
        <link
          ...
          href="/icons/windows11/Square150x150Logo.scale-100.png"
        />
        <meta name="msapplication-TileColor" content="#FFEEDB" />
        <meta
          name="msapplication-TileImage"
          content="/icons/windows11/Square150x150Logo.scale-100.png"
        />
        <meta name="theme-color" content="#FFEEDB" />
        <link
        ...
        <script suppressHydrationWarning={true} type="text/css">
          {
            '*,:after,:before{box-sizing:border-box;border:0 solid}:after,:before{--tw-content:""}html{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;-o-tab-size:4;tab-size:4;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji}body{margin:0;line-height:inherit}h2{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}:-moz-focusring{outline:auto}:-moz-ui-invalid{box-shadow:none}::-webkit-inner-spin-button,::-webkit-outer-spin-button{height:auto}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}figure,h2,p{margin:0}img,svg{display:block;vertical-align:middle}img{max-width:100%;height:auto}::-webkit-datetime-edit-fields-wrapper{padding:0}::-webkit-date-and-time-value{min-height:1.5em}*,:after,:before{--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:#415A77;--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: }.container{width:100%}@media (max-width:1024px){#grid-item{grid-column:span 3!important}}.absolute{position:absolute}.relative{position:relative}.-right-2{right:-.5rem}.-top-2{top:-.5rem}.z-10{z-index:10}.mx-auto{margin-left:auto;margin-right:auto}.mt-4{margin-top:1rem}.flex{display:flex}.h-80{height:20rem}.h-full{height:100%}.h-5{height:1.25rem}.w-full{width:100%}.w-60{width:15rem}.w-5{width:1.25rem}.flex-col{flex-direction:column}.items-start{align-items:flex-start}.items-center{align-items:center}.justify-between{justify-content:space-between}.justify-evenly{justify-content:space-evenly}.gap-5{gap:1.25rem}.gap-1{gap:.25rem}.self-end{align-self:flex-end}.overflow-hidden{overflow:hidden}.rounded-xl{border-radius:.75rem}.rounded-2xl{border-radius:1rem}.rounded-full{border-radius:1000px}.rounded-r-xl{border-top-right-radius:.75rem;border-bottom-right-radius:.75rem}.bg-primary{--tw-bg-opacity:1;background-color:rgb(255 247 240/var(--tw-bg-opacity))}.bg-background1{--tw-bg-opacity:1;background-color:rgb(240 239 235/var(--tw-bg-opacity))}.bg-grey{background-color:#00000008}.bg-text{--tw-bg-opacity:1;background-color:rgb(55 53 103/var(--tw-bg-opacity))}.p-8{padding:2rem}.p-5{padding:1.25rem}.px-5{padding-left:1.25rem;padding-right:1.25rem}.px-2{padding-left:.5rem;padding-right:.5rem}.py-1{padding-top:.25rem;padding-bottom:.25rem}.py-7{padding-top:1.75rem;padding-bottom:1.75rem}.py-20{padding-top:5rem;padding-bottom:5rem}.text-center{text-align:center}.text-3xl{font-size:1.875rem;line-height:2.25rem}.text-sm{font-size:.875rem;line-height:1.25rem}.font-bold{font-weight:700}.text-primary{--tw-text-opacity:1;color:rgb(255 247 240/var(--tw-text-opacity))}'
          }
        </script>
        <script
          defer
          src="
          https://pim.crystallize.com/static/frontend-preview-listener.js"
        />
        <script
          src="https://kit.fontawesome.com/8a99b84de1.js"
...
function Logo(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    ...
    >
      <g
        transform="translate(0.000000,90.000000) scale(0.018000,-0.018000)"
        fill="#000000"
        stroke="none"
      >
        <path
          d="M240 2505 l0 -2255 2255 0 2255 0 0 2255 0 2255 -2255 0 -2255 0 0
-2255z m4460 0 l0 -2205 -2205 0 -2205 0 0 2205 0 2205 2205 0 2205 0 0 -2205z"
        />
        <path
          d="M2215 4290 c-178 -38 -311 -133 -351 -252 -24 -71 -23 -178 1 -248
...
-819 25 -97 64 -147 154 -147 263 0 196 150 320 430 356 102 14 313 3 409 -20z"
        />
        <path
          d="M2345 4045 c-46 -22 -63 -39 -81 -80 -30 -73 8 -149 91 -181 67 -25
...
-165 36 -165 111 0 20 25 84 33 84 1 0 20 7 42 15 48 17 126 19 179 4z"
        />
        <path
          d="M3555 4295 c-267 -49 -404 -189 -393 -400 8 -138 77 -236 212 -301
...
308 5 394 -13z"
        />
        <path
          d="M3653 4040 c-111 -50 -111 -200 0 -250 57 -27 186 -27 242 -1 65 30
...
-24 162 40 38 143 52 218 31z"
        />
        <path
          d="M580 3916 l0 -386 365 0 c201 0 409 5 462 11 199 22 316 82 342 174
...
-53 -134 -56 -587 -61 l-423 -4 0 346 0 346 408 0 c335 0 418 -3 467 -15z"
        />
        <path
          d="M990 4045 l0 -45 146 0 c81 0 154 5 165 10 11 6 19 21 19 35 0 14 -8
29 -19 35 -11 5 -84 10 -165 10 l-146 0 0 -45z"
        />
        <path
          d="M990 3790 l0 -50 158 0 c168 0 202 8 202 50 0 42 -34 50 -202 50
l-158 0 0 -50z"
        />
        <path
          d="M2245 2873 c-186 -29 -324 -112 -382 -231 -25 -51 -28 -68 -28 -157
...
178 438 579 422 63 -2 144 -11 179 -19z"
        />
        <path
          d="M3488 2870 c-192 -33 -329 -118 -387 -240 -22 -47 -26 -69 -25 -145
...
61 112 201 188 393 212 111 14 320 5 418 -19z"
        />
        <path
          d="M3563 2611 c-72 -34 -102 -113 -68 -184 28 -59 74 -81 180 -85 79 -3
...
55 -21 32 -21 97 2 124 35 44 150 64 234 41z"
        />
        <path
          d="M670 2485 l0 -385 220 0 220 0 0 88 c0 73 3 92 18 105 10 10 22 17
...
0 345 190 0 189 0 3 -119z"
        />
        <path
          d="M560 1055 l0 -385 225 0 224 0 3 106 3 107 89 -107 89 -106 82 0 82
...
0 170 0 163 -188z"
        />
        <path
          d="M2100 1054 l0 -386 428 5 c473 5 513 9 632 69 80 41 110 81 110 150
...
0 0 346 0 345 438 -3 437 -3 67 -33z"
        />
        <path
          d="M2510 1185 l0 -45 148 0 c132 0 151 2 165 18 22 24 21 35 -1 55 -16
14 -43 17 -165 17 l-147 0 0 -45z"
        />
        <path
          d="M2510 930 l0 -50 158 0 c126 0 162 3 180 16 27 19 28 38 2 64 -18 18
-33 20 -180 20 l-160 0 0 -50z"
        />
        <path
          d="M3370 1055 l0 -385 515 0 515 0 0 120 0 120 -290 0 c-250 0 -290 2
